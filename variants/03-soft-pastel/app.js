/**
 * Soft pastel weather: current conditions + 10-day forecast.
 * Every temperature is shown in both °F and °C at the same time.
        ...
        return `
          <li role="presentation">
            <button
              ...
              aria-selected="false"
            >
              <span class="search-popup__pin" aria-hidden="true">📍</span>
              <span class="search-popup__text">
...
/** Pastel cold periwinkle → warm apricot, mapped over roughly -10 °C … 35 °C. */
...
function renderCurrent(placeName, data) {
  ...
  els.hl.innerHTML = hlChipHtml("H", hi) + hlChipHtml("L", lo);
  els.hl.setAttribute(
    "aria-label",
          ...
          <span class="day__range" aria-hidden="true">
            <span class="bar">
              <span class="bar__fill" style="left:${left.toFixed(
                ...
                lo
              )};--to:${tempColor(hi)};animation-delay:${(i * 35).toFixed(0)}ms"></span>
              ${nowDot}
            </span>
          </span>
          <span class="t t--hi">
